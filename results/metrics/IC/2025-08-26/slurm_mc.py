...
def job_func(job_name):
    ...
    s += 'export PYTHONWARNINGS="ignore:RuntimeWarning:runpy"\n'
    s += 'python -u -m simulations.monte_carlo 2>&1   | grep -Ev "All log messages before absl::InitializeLog|Unable to register cuDNN factory|Unable to register cuBLAS factory"\n'
    return s
