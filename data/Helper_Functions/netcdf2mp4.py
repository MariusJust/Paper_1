...
# user parameters #########################################################################
netcdf_file = r'..\RawData\cru_ts4.08.1901.2020.tmp.dat.nc' # input netcdf file
netcdf_var = 'tmp' #variable of interest
output_gif = r'.\cru_ts4.08.1901.2020.tmp.gif' #output gif file
output_mp4 = r'.\cru_ts4.08.1901.2020.tmp.mp4' #output mp4 file
