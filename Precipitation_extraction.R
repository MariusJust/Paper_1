...
pacman::p_load(raster, sf, ncdf4, readxl, dplyr, rnaturalearth,tidyverse, hash, parallel, foreach, doParallel, snow, utils, data.table) #installing necessary packages 
n_cores<-detectCores()
